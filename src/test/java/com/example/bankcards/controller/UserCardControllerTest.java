...
class UserCardControllerTest {
    ...
    void getUserCards_ShouldReturnUserCards() throws Exception {
        ...
        card1.setCardHolderName("User One");
        card1.setExpiryDate(YearMonth.of(2025, 12));
        card1.setCvv("123");
        card1.setBalance(BigDecimal.valueOf(1000.00));
        card1.setStatus("ACTIVE");

        CardResponse card2 = new CardResponse();
        card2.setId(2L);
        card2.setCardNumber("4222222222222222");
        card2.setCardHolderName("User One");
        card2.setExpiryDate(YearMonth.of(2026, 6));
        card2.setCvv("456");
        ...
        when(cardService.getUserCards("user1")).thenReturn(cards);
    ...
    void getCardById_ShouldReturnCard() throws Exception {
        ...
        card.setCardHolderName("User One");
    ...
    void blockCard_ShouldBlockCard() throws Exception {
        ...
        blockedCard.setCardHolderName("User One");
        blockedCard.setExpiryDate(YearMonth.of(2025, 12));
    ...
    void getUserCards_ForUser2_ShouldReturnUser2Cards() throws Exception {
        ...
        CardResponse card = new CardResponse();
        card.setId(3L);
        card.setCardNumber("4333333333333333");
        card.setCardHolderName("User Two");
        card.setExpiryDate(YearMonth.of(2025, 9));
        card.setCvv("789");
